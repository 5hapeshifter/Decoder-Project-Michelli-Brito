...
public class UserController {
    ...
    @Autowired
    UserServiceImpl userServiceImpl; // Perguntar para a Michelli se não deveria ser usado esse objeto ao inves do outro
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<Object> getOneUser(@PathVariable(value = "userId") UUID userId) { // como temos dois tipos de resposta, String ou UserModel, estamos usando o object como tipo
    ...
    public ResponseEntity<Object> updatePassword(@PathVariable(value = "userId") UUID userId,
        ...
        if (!userModelOptional.get().getPassword().equals(userDto.getOldPassword())){
            ...
            log.warn("Password updated successfully userId {}", userModel.getUserId());
    ...
    public ResponseEntity<Object> updateImage(@PathVariable(value = "userId") UUID userId,
        ...
        if(!userModelOptional.isPresent()){
            ...
            log.warn("Image updated successfully userId {}", userModel.getUserId());
            return ResponseEntity.status(HttpStatus.OK).body(userModel);
        }
    }
}
